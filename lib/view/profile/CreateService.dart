...
// import '../../helpers/route.dart'; // Assuming AppRoutes is defined here
...
//
//           // --- 1. Boarding Service (CREATE MODE) ---
//           _buildServiceItem(
//             iconPath: 'assets/icons/calendar-add-01 (1).svg',
//             title: 'Boarding',
//             subtitle: 'In the sitter\'s home',
//             // Assumes AppRoutes.bording leads to BoardingSetupScreen(isEditing: false)
//             onTap: () {
...
//
//           // --- 2. Doggy Day Care Service (CREATE MODE) ---
//           _buildServiceItem(
//             iconPath: 'assets/icons/home-hashtag.svg',
//             title: 'Doggy Day Care',
//             subtitle: 'In your home',
//             // Assumes AppRoutes.dogDay leads to DoggyDayCareSetupScreen(isEditing: false)
//             onTap: () {
...
//           SizedBox(height: 16.h),
//
//           // --- 3. Dog Walking Service (CREATE MODE) ---
//           _buildServiceItem(
//             iconPath: 'assets/icons/lochome.svg',
//             title: 'Dog Walking',
//             subtitle: 'Visits in your home',
//             // Assumes AppRoutes.dogwalk leads to DogWalkingSetupScreen(isEditing: false)
//             onTap: () {
